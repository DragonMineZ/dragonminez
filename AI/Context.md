...
- First person draws fewer, thinner bolts on a wider arc in front of the camera (model-space forward is -Z there). Under Iris there is no depth test, as with the other effects. Bloom is a queued redraw of the same seeded geometry.
