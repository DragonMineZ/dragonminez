...
public class QuestTreeLayoutHelper {
	...
	public static class NodeConnection {
		...
		@java.lang.SuppressWarnings("all")
		public NodePosition getFrom() {
			return this.from;
		}

		@java.lang.SuppressWarnings("all")
		public NodePosition getTo() {
			return this.to;
		}
	}
	...
	public static class TreeLayout {
		...
		@java.lang.SuppressWarnings("all")
		public List<NodePosition> getNodes() {
			return this.nodes;
		}
	...
	public static TreeLayout computeLayout(Saga saga) {
		...
		if (minPixelY < 0) {
			...
			for (NodePosition node : nodes) {
				shiftedNodes.add(new NodePosition(node.getQuest(), node.getGridCol(), node.getGridRow(), node.getPixelX(), node.getPixelY() + shift, node.isSidequest()));
			}
	...
	private static NodePosition findSagaParentNode(Quest child, String sagaId, Map<Integer, NodePosition> sagaNodeMap, List<Quest> sagaQuests, int childIndex) {
	 ...
	 */
	private static int findAttachColumn(Quest sidequest, String sagaId, Map<Integer, NodePosition> sagaNodeMap, Map<String, NodePosition> sideNodeMap) {
	 ...
	 */
	private static NodePosition findParentNode(Quest sidequest, String sagaId, Map<Integer, NodePosition> sagaNodeMap, Map<String, NodePosition> sideNodeMap) {
