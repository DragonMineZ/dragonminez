...
public class FlightSpeedLimitOptionNode extends AbstractRadialNode {

	private final int value;

	public FlightSpeedLimitOptionNode(int value) {
		this.value = value;
	}
	...
	public boolean active(StatsData stats) {
		return stats.getResources().getFlightSpeedLimit() == value;
	}
	...
	public void onSelect(StatsData stats) {
		NetworkHandler.sendToServer(new SetFlightSpeedLimitC2S(value));
		playClick();
	}
}
