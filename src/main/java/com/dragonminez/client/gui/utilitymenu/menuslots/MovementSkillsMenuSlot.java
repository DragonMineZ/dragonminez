...
public class MovementSkillsMenuSlot extends AbstractMenuSlot implements IUtilityMenuSlot {
	...
	static {
		...
		FUNCTIONS.add(new MenuFunction(
				"sprint",
				stats -> stats.getSkills().hasSkill("sprint"),
				stats -> stats.getSkills().isSkillActive("sprint"),
				(stats, wasActive) -> NetworkHandler.sendToServer(new UpdateSkillC2S(UpdateSkillC2S.SkillAction.TOGGLE, "sprint", 0))
		));
	}
