...
//        stackFormData.put(StackForms.X100, x100);
	...
	private void createDefaultHumanForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
		...
		shin_shiyoken.setStrMultiplier(4.85);
        ...
        chou_shiyoken.setStrMultiplier(5.5);
	...
	private void createAndroidForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
		...
		androidBase.setStrMultiplier(1.7);
		androidBase.setSkpMultiplier(1.6);
		androidBase.setDefMultiplier(1.35);
		androidBase.setPwrMultiplier(2.0);
		...
		superAndroid.setStrMultiplier(2.6);
		superAndroid.setSkpMultiplier(2.5);
		superAndroid.setDefMultiplier(1.9);
		superAndroid.setPwrMultiplier(3.0);
		...
		fusedAndroid.setStrMultiplier(3.6);
		fusedAndroid.setSkpMultiplier(3.5);
		fusedAndroid.setDefMultiplier(2.4);
		fusedAndroid.setPwrMultiplier(4.0);
