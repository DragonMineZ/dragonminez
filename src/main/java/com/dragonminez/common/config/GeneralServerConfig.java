...
public class GeneralServerConfig {
	...
	public static class WorldGenConfig {
		...
		public boolean isGenerateCustomStructures() {
			return generateCustomStructures;
		}

		public boolean isGenerateDragonBalls() {
			return generateDragonBalls;
		}

		public boolean isOtherworldActive() {
			return otherworldActive;
		}

		public int getDBSpawnRange() {
	...
	public static class GameplayConfig {
		...
		public boolean isCommandOutputOnConsole() {
			return commandOutputOnConsole;
		}
		...
		public boolean isCreateDefaultSagas() {
			return createDefaultSagas;
		}

		public int getSenzuCooldownTicks() {
		...
		public int getFusionDurationSeconds() {
			return Math.max(0, Math.min(fusionDurationSeconds, Integer.MAX_VALUE));
		}

		public int getFusionCooldownSeconds() {
	...
	public static class CombatConfig {
		...
		public boolean isKillPlayersOnCombatLogout() {
			return killPlayersOnCombatLogout;
		}
		...
		public boolean isRespectAttackCooldown() {
			return respectAttackCooldown;
		}

		public boolean isEnableBlocking() {
			return enableBlocking;
		}

		public boolean isEnableParrying() {
			return enableParrying;
		}

		public boolean isEnableComboAttacks() {
			return enableComboAttacks;
		}

		public boolean isEnablePerfectEvasion() {
			return enablePerfectEvasion;
		}

		public int getComboAttacksCooldownSeconds() {
			return Math.max(0, Math.min(comboAttacksCooldownSeconds, Integer.MAX_VALUE));
		}

		public int getParryWindowMs() {
	...
	public static class RacialSkillsConfig {
		...
		public boolean isEnableRacialSkills() {
			return enableRacialSkills;
		}

		public boolean isHumanRacialSkill() {
			return humanRacialSkill;
		}
		...
		public boolean isSaiyanRacialSkill() {
			return saiyanRacialSkill;
		}

		public int getSaiyanZenkaiAmount() {
		...
		public String[] getSaiyanZenkaiBoosts() {
			return saiyanZenkaiBoosts;
		}

		public int getSaiyanZenkaiCooldownSeconds() {
			return Math.max(0, Math.min(saiyanZenkaiCooldownSeconds, Integer.MAX_VALUE));
		}

		public boolean isNamekianRacialSkill() {
			return namekianRacialSkill;
		}

		public int getNamekianAssimilationAmount() {
		...
		public String[] getNamekianAssimilationBoosts() {
			return namekianAssimilationBoosts;
		}

		public boolean isNamekianAssimilationOnNamekNpcs() {
			return namekianAssimilationOnNamekNpcs;
		}

		public boolean isFrostDemonRacialSkill() {
			return frostDemonRacialSkill;
		}
		...
		public boolean isBioAndroidRacialSkill() {
			return bioAndroidRacialSkill;
		}

		public int getBioAndroidCooldownSeconds() {
		...
		public boolean isMajinAbsoprtionSkill() {
			return majinAbsoprtionSkill;
		}

		public boolean isMajinReviveSkill() {
			return majinReviveSkill;
		}

		public int getMajinAbsorptionAmount() {
		...
		public String[] getMajinAbsorptionBoosts() {
			return majinAbsorptionBoosts;
		}

		public boolean isMajinAbsorptionOnMobs() {
			return majinAbsorptionOnMobs;
		}

		public int getMajinReviveCooldownSeconds() {
