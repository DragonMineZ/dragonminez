package com.dragonminez.common.init.armor.client.model;// Made with Blockbench 5.1.6
...
public class ArmorPatrollerModel extends HumanoidModel<LivingEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "armors"), "patroller");
	...
	public ArmorPatrollerModel(ModelPart root) {
        super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = right_leg.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 32).addBox(-4.0F, -1.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(1.65F, -0.5F, 0.0F, 0.0F, 0.0F, 0.1309F));
		...
		PartDefinition cube_r4 = left_leg.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 32).mirror().addBox(0.0F, -1.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.25F)).mirror(false), PartPose.offsetAndRotation(-1.65F, -0.5F, 0.0F, 0.0F, 0.0F, -0.1309F));
