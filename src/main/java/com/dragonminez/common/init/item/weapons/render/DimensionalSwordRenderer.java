...
public class DimensionalSwordRenderer extends GeoItemRenderer<DimensionalSwordItem> {
	...
	@Override
	public void actuallyRender(PoseStack poseStack, DimensionalSwordItem animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
