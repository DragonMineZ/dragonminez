...
public class Character {
	...
	public void updateOozaruCache() {
		...
		this.oozaruCached = logicKey.startsWith("oozaru") || (raceName.equals("saiyan") && (Objects.equals(currentForm, com.dragonminez.common.util.lists.SaiyanForms.OOZARU) || Objects.equals(currentForm, com.dragonminez.common.util.lists.SaiyanForms.GOLDEN_OOZARU)));
	}
	...
	public Float[] getResolvedModelScaling() {
		...
		return new Float[] {resolveAxis(formScale[0], stackScale[0]), resolveAxis(formScale[1], stackScale[1]), resolveAxis(formScale[2], stackScale[2])};
	}
	...
	private void addMasteryResolved(String group, String form, double amount) {
		...
		FormConfig.FormData formData = isStack ? ConfigManager.getStackForm(group, form) : ConfigManager.getForm(getRaceName(), group, form);
	...
	private FormConfig.FormData resolveFormData(String group, String form) {
		boolean isStack = ConfigManager.getStackFormGroup(group) != null;
		return isStack ? ConfigManager.getStackForm(group, form) : ConfigManager.getForm(getRaceName(), group, form);
	}
	...
	@java.lang.SuppressWarnings("all")
	public void setSelectedMaster(final String selectedMaster) {
		this.selectedMaster = selectedMaster;
	}

	@java.lang.SuppressWarnings("all")
	public void setActiveFormGroup(final String activeFormGroup) {
		this.activeFormGroup = activeFormGroup;
	}

	@java.lang.SuppressWarnings("all")
	public void setActiveForm(final String activeForm) {
		this.activeForm = activeForm;
	}

	@java.lang.SuppressWarnings("all")
	public void setFormsUsedBefore(final UsedForms formsUsedBefore) {
		this.formsUsedBefore = formsUsedBefore;
	}

	@java.lang.SuppressWarnings("all")
	public void setActiveFormItemDurationTicks(final int activeFormItemDurationTicks) {
		this.activeFormItemDurationTicks = activeFormItemDurationTicks;
	}

	@java.lang.SuppressWarnings("all")
	public void setPreviousFormGroup(final String previousFormGroup) {
		this.previousFormGroup = previousFormGroup;
	}

	@java.lang.SuppressWarnings("all")
	public void setPreviousForm(final String previousForm) {
		this.previousForm = previousForm;
	}

	@java.lang.SuppressWarnings("all")
	public void setHasPreviousFormRecord(final boolean hasPreviousFormRecord) {
		this.hasPreviousFormRecord = hasPreviousFormRecord;
	}

	@java.lang.SuppressWarnings("all")
	public void setActiveStackFormGroup(final String activeStackFormGroup) {
		this.activeStackFormGroup = activeStackFormGroup;
	}

	@java.lang.SuppressWarnings("all")
	public void setActiveStackForm(final String activeStackForm) {
		this.activeStackForm = activeStackForm;
	}

	@java.lang.SuppressWarnings("all")
	public void setStackFormsUsedBefore(final UsedForms stackFormsUsedBefore) {
		this.stackFormsUsedBefore = stackFormsUsedBefore;
	}

	@java.lang.SuppressWarnings("all")
	public void setActiveStackFormItemDurationTicks(final int activeStackFormItemDurationTicks) {
		this.activeStackFormItemDurationTicks = activeStackFormItemDurationTicks;
	}

	@java.lang.SuppressWarnings("all")
	public void setPreviousStackFormGroup(final String previousStackFormGroup) {
		this.previousStackFormGroup = previousStackFormGroup;
	}

	@java.lang.SuppressWarnings("all")
	public void setPreviousStackForm(final String previousStackForm) {
		this.previousStackForm = previousStackForm;
	}

	@java.lang.SuppressWarnings("all")
	public void setHasPreviousStackFormRecord(final boolean hasPreviousStackFormRecord) {
	...
	@java.lang.SuppressWarnings("all")
	public void setRenderHairBase(final boolean renderHairBase) {
	...
	@java.lang.SuppressWarnings("all")
	public void setHairBase(final CustomHair hairBase) {
		this.hairBase = hairBase;
	}

	@java.lang.SuppressWarnings("all")
	public void setHairSSJ(final CustomHair hairSSJ) {
		this.hairSSJ = hairSSJ;
	}

	@java.lang.SuppressWarnings("all")
	public void setHairSSJ2(final CustomHair hairSSJ2) {
		this.hairSSJ2 = hairSSJ2;
	}

	@java.lang.SuppressWarnings("all")
	public void setHairSSJ3(final CustomHair hairSSJ3) {
		this.hairSSJ3 = hairSSJ3;
	}

	@java.lang.SuppressWarnings("all")
	public void setActiveHeadBone(final String activeHeadBone) {
	...
	@java.lang.SuppressWarnings("all")
	public void setEyesType(final int eyesType) {
		this.eyesType = eyesType;
	}

	@java.lang.SuppressWarnings("all")
	public void setNoseType(final int noseType) {
		this.noseType = noseType;
	}

	@java.lang.SuppressWarnings("all")
	public void setMouthType(final int mouthType) {
		this.mouthType = mouthType;
	}

	@java.lang.SuppressWarnings("all")
	public void setTattooType(final int tattooType) {
		this.tattooType = tattooType;
	}

	@java.lang.SuppressWarnings("all")
	public void setBoobScale(final float boobScale) {
		this.boobScale = boobScale;
	}

	@java.lang.SuppressWarnings("all")
	public void setRgbBodyColor(final float[] rgbBodyColor) {
	...
	@java.lang.SuppressWarnings("all")
	public void setOozaruCached(final boolean oozaruCached) {
