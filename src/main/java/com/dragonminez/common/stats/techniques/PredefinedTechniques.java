...
public class PredefinedTechniques {
	...
	public void init() {
		...
		registerKi("supernova_cooler", "technique.dragonminez.supernova_cooler", "Cooler", KiAttackData.KiType.GIANT_BALL, 3.50F, 0xFF3866, 0xA3143A, 0x4A0316, 10.5F, 0.5F, 10, "ki.supernova_cooler");
		registerKi("big_bang", "technique.dragonminez.big_bang", "Vegeta", KiAttackData.KiType.MEDIUM_BALL, 2.00F, 0xE3FFFF, 0xE3FFFF, 0x889999, 1.2F, 1.5F, 10, "ki.bigbang");
		registerKi("burning_attack", "technique.dragonminez.burning_attack", "Trunks", KiAttackData.KiType.MEDIUM_BALL, 1.50F, 0xFFF3D0, 0xFF7A1A, 0xC43A00, 2.0F, 1.5F, 10, "ki.burning_attack");
