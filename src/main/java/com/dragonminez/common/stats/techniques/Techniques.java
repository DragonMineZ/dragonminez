...
public class Techniques {
	...
	@java.lang.SuppressWarnings("all")
	public void setTechniqueCharging(final boolean techniqueCharging) {
		this.techniqueCharging = techniqueCharging;
	}

	@java.lang.SuppressWarnings("all")
	public void setChargeHolding(final boolean chargeHolding) {
	...
	@java.lang.SuppressWarnings("all")
	public void setHomingTargetId(final int homingTargetId) {
