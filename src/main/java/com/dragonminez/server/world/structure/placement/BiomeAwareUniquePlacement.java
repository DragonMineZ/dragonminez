...
public class BiomeAwareUniquePlacement extends StructurePlacement {
	public static final MapCodec<BiomeAwareUniquePlacement> CODEC = RecordCodecBuilder.mapCodec(instance -> placementCodec(instance).and(instance.group(RegistryCodecs.homogeneousList(Registries.BIOME).fieldOf("valid_biomes").forGetter(BiomeAwareUniquePlacement::getValidBiomes), Rotation.CODEC.optionalFieldOf("rotation", Rotation.NONE).forGetter(BiomeAwareUniquePlacement::getRotation))).apply(instance, BiomeAwareUniquePlacement::new));
