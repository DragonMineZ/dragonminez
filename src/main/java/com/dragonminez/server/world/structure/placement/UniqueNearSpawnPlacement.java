...
public class UniqueNearSpawnPlacement extends StructurePlacement {
	public static final MapCodec<UniqueNearSpawnPlacement> CODEC = RecordCodecBuilder.mapCodec(instance -> placementCodec(instance).and(Rotation.CODEC.optionalFieldOf("rotation", Rotation.NONE).forGetter(p -> p.rotation)).apply(instance, UniqueNearSpawnPlacement::new));
	private final Rotation rotation;

	public UniqueNearSpawnPlacement(Vec3i locateOffset, FrequencyReductionMethod frequencyReductionMethod, float frequency, int salt, Optional<ExclusionZone> exclusionZone, Rotation rotation) {
	...
	public UniqueNearSpawnPlacement(Vec3i locateOffset, FrequencyReductionMethod frequencyReductionMethod, float frequency, int salt, Optional<ExclusionZone> exclusionZone) {
